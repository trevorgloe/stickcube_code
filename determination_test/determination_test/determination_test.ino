...
struct args{
  float T=0.2;
  float omega = 1.0; // make it const float or #define (a little better/cooler this way)
  ...
  switch (state) {
    ...
    case 1:
      ...
      if ((currentMillis - previousMillis)/1000 < tmax) {
        ...
        //print time
        String time_str = String(currentMillis);
        Serial.print("Time: " + time_str + "\t");
         
        //print quaternians
        String q1 = String(q.r);
        String q2 = String(q.i);
        String q3 = String(q.j);
        String q4 = String(q.k);
        String quat_full = "r: " + q1 + "\t" + "i: " + q2 + "\t"  "j: " + q3 + "\t" + "k: " + q4;
        Serial.print(quat_full + " \t");

        String thetax = String(ret.return_value_x);
        String thetay = String(ret.return_value_y);
        String angle_full = "xang: " + thetax + "\t" + "yang: " + thetay;
        Serial.print(angle_full + " \n");
